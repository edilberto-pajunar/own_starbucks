...
class EditCustomizeView extends StatefulWidget {
  ...
  const EditCustomizeView({super.key, required this.drink});

  @override
  State<EditCustomizeView> createState() => _EditCustomizeViewState();
}

class _EditCustomizeViewState extends State<EditCustomizeView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: _deleteCustomizedDrink,
            ...
            Expanded(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _updateCustomizedDrink,
